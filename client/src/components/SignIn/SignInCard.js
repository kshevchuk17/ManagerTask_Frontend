...
export const SignInCard = () => {
    ...
    return (
        <div id="Login-appRoot">
            <div className="SignInCardLayout">
                <div className=" SignInCardLayout_card">
                    <a className="Title">
                        Task Manager
                    </a>
                    <div className="SignInDefaultView">
                        <div className="GoogleAuthButton" role="button" tabIndex="0" onClick={history.push('')}>
                            <svg
                                className="GoogleSignInButton-logoQ"
                                viewBox="0 0 18 18">
                                <path
                        ...
                        <span className="SeparatorRow">
                            <span className="SeparatorRow_horizontalLine"/>
                            <span className="SeparatorRow_label">
                                or
                            </span>
                            <span className="SeparatorRow_horizontalLine"/>
                        </span>
                        <form className="SignInEmailPasswordForm">
                            <div className="SignInEmailPasswordForm_emailAndPassword">
                                <span className="PasswordAndEmailLabel">
                                    Email address
                                </span>
                                <input type="text" className="InputEmailAndPassword"
                                       name="username" value={form.username} onChange={changeHandler}
                            ...
                            <a className="Secondary_link" href="ссылка на востановление пароля">
                                <span className="ForgotYourPassword">
                                    Forgot your password?
                                </span>
                            </a>
                            <div className="SignInButton" role="button" aria-disabled="false" onClick={loginHandler}>
                                Sign in
                            </div>
                        </form>
                        <div className="SignUpDefaultView">
                            <span className="DontHaveAnyAccount">
                                Don't have account?
                            </span>
                            <a className="SignUpButtonLink" href="\signUp\">
                                Sign up
                            </a>
                        </div>
                    </div>
